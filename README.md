...
- Si lo pruebas dentro de un entorno con vista previa en sandbox (como el chat de Claude), es posible que el guardado no persista entre sesiones; al abrirlo como archivo normal o publicarlo en GitHub Pages funciona sin problema.
